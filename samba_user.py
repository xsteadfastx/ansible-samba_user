...
# (c) 2016, Marvin Steadfast <marvin@xsteadfastx.org>
#
...
---
module: samba_user
short_description: Manager samba user accounts through pdbedit and smbpasswd.
author: "Marvin Steadfast (@xsteadfastx)"
version_added: "2.1"
requirements: [ pdbedit, smbpasswd ]
options:
    name:
        description:
